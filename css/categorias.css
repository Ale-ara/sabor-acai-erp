        ...
        lista.innerHTML += `
            <div class="categoria-card">
                ...
                <div class="categoria-actions">
                    <button
                        type="button"
                        class="edit-categoria-btn"
                        data-categoria-id="${idSeguro}"
                    >
                        Editar
                    </button>
                    ...
                    <button
                        type="button"
                        class="delete-btn delete-categoria-btn"
                        data-categoria-id="${idSeguro}"
                    >
                        Excluir
                    </button>
...
function configurarAcoesCategorias(){
    ...
    lista.addEventListener('click', event => {
        const botao =
        event.target.closest('[data-categoria-id]')
        ...
        if(botao.classList.contains('edit-categoria-btn')){
            editarCategoria(id)
            return
        }

        if(botao.classList.contains('delete-categoria-btn')){
            abrirPopupExcluirCategoria(id)
        }
    })
}
